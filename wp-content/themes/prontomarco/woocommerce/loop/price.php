...
<?php if ( $price_html = $product->get_price_html() ) : ?>
    ...
    <span style="font-size: 0.8751rem; margin-top: -10px; margin-bottom: 15px; display: block;"><?= CUOTAS_SIN_INTERES ?> cuotas <span style="font-weight: 700; color: #444;">SIN INTERÉS</span> </span>
